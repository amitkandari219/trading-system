"""Run dry-run extraction for all 10 books with JSON saving, 4 parallel workers."""
import logging
import time
...
# All 10 books — re-run completed ones to capture chunk_type
BOOKS = ['HARRIS', 'DOUGLAS', 'GUJRAL', 'SINCLAIR', 'HILPISCH',
         'LOPEZ', 'GRIMES', 'NATENBERG', 'KAUFMAN', 'MCMILLAN']
